...
# VOID = void # alias
GXAO_INVALID_CLOCK_RATE = -58 # Variable c_int '-0x0000000000000003a'
GXAO_CAL_NOT_IN_CALIBRATION_MODE = -72 # Variable c_int '-0x00000000000000048'
...
GXAO_INVALID_ARB_MODE = -75 # Variable c_int '-0x0000000000000004b'
GXAO_INVALID_CHANNEL = -51 # Variable c_int '-0x00000000000000033'
GXAO_CHANNEL_NOT_ARB = -60 # Variable c_int '-0x0000000000000003c'
...
GXAO_ARB_IS_RUNNING = -63 # Variable c_int '-0x0000000000000003f'
GXAO_1649_TRIGGERMODE_STAR = 10 # Variable c_int '10'
GXAO_INVALID_VOLTAGE_RANGE = -52 # Variable c_int '-0x00000000000000034'
GT_BOARD_NOT_EXIST = -2 # Variable c_int '-0x00000000000000002'
GXAO_GROUP_GLOBAL_GROUPS = 4 # Variable c_int '4'
GXAO_VOLTAGE_OUT_OF_RANGE = -55 # Variable c_int '-0x00000000000000037'
GXAO_INVALID_TRIGGER_MODE = -67 # Variable c_int '-0x00000000000000043'
...
GXAO_DIO_INVALID_MEMORY_TYPE = -70 # Variable c_int '-0x00000000000000046'
GXAO_INVALID_CLOCK_SOURCE = -68 # Variable c_int '-0x00000000000000044'
GXAO_UNABLE_TO_LOCK_CHANNEL = -57 # Variable c_int '-0x00000000000000039'
GXAO_1649_CLOCKSOURCE_GROUPA = 11 # Variable c_int '11'
GXAO_CAL_INVALID_CHANNEL_GAIN = -64 # Variable c_int '-0x00000000000000040'
...
GXAO_INVALID_GROUP = -50 # Variable c_int '-0x00000000000000032'
GXAO_DIO_ALLOCATED_SIZE_EXCEEDED = -71 # Variable c_int '-0x00000000000000047'
GXAO_CHANNEL_BUSY_TIMEOUT = -56 # Variable c_int '-0x00000000000000038'
...
GXAO_DIO_IS_RUNNING = -74 # Variable c_int '-0x0000000000000004a'
...
GXAO_DIO_MEMORY_SIZE_EXCEEDED = -69 # Variable c_int '-0x00000000000000045'
...
GXAO_INVALID_PORT_BIT_NUMBER = -54 # Variable c_int '-0x00000000000000036'
GT_NOT_IN_CALIBRATION_MODE = -11 # Variable c_int '-0x0000000000000000b'
GXAO_1649_WAVEFORM_TYPE_DOUBLE = 1 # Variable c_int '1'
GXAO_CHANNEL_NOT_STATIC = -62 # Variable c_int '-0x0000000000000003e'
...
GT_NOT_MTS_BOARD = -14 # Variable c_int '-0x0000000000000000e'
GXAO_CAL_INVALID_ADC_OFFSET = -66 # Variable c_int '-0x00000000000000042'
...
GXAO_INVALID_PORT_DIRECTION = -53 # Variable c_int '-0x00000000000000035'
GXAO_INVALID_MEMORY_CONFIG = -59 # Variable c_int '-0x0000000000000003b'
...
GXAO_CAL_INVALID_ADC_GAIN = -65 # Variable c_int '-0x00000000000000041'
...
GXAO_ARB_MEMORY_SIZE_EXCEEDED = -61 # Variable c_int '-0x0000000000000003d'
...
GXAO_STREAMING_NOT_SUPPORTED_BY_FIRMWARE = -76 # Variable c_int '-0x0000000000000004c'
...
GXAO_CAL_INVALID_VOLTAGE_POINT = -73 # Variable c_int '-0x00000000000000049'
...
__all__ = ['GxAoCalGroupChannel', 'GXAO_INVALID_CLOCK_RATE',
           ...
           'GxAoGetDriverSummary', 'GT_BOARD_NOT_EXIST',
           'GXAO_GROUP_GLOBAL_GROUPS', 'GXAO_VOLTAGE_OUT_OF_RANGE',
           'GXAO_INVALID_TRIGGER_MODE', 'GxAoCalSetVoltagePoint',
           'GxAoArbIsGroupStreaming', 'GT_INVALID_PARAMETER',
           'GxAoArbArmGroup', 'GT_NOT_PXI_BOARD',
           'GXAO_1649_CLOCKSOURCE_EXTERNAL', 'PSTR',
           'GXAO_1649_ARB_STREAMING_STATUS_FULL',
           ...
           'GXAO_ZERO_TO_POS5V', 'PLONG', 'GT_EVENT_WAIT_TIMEOUT',
           ...
           'GxAoGetPortBit', 'GT_VISA_OPENDEFAULTRM_ERROR',
           ...
           'GxAoResetGroup', 'GXAO_1649_TRIGGERMODE_EXTERNAL',
           ...
           'GxAoUpdateAllGroupsVoltage', 'GxAoDioTrig',
           'GT_VISA_LOAD_DLL_ERROR', 'BYTE', 'GxAoUpdateGroupVoltage',
           'BOOL', 'GxAoDioArm', 'GT_NOT_CALIBRATED',
           'GT_UNABLE_TO_GETTIMER', 'GT_VISA_VIIN_ERROR',
           'GT_BOARD_INVALID_EEPROM', 'GT_UNABLE_TO_OPEN_FILE',
           'GxAoArbReadChannelWaveform', 'GxAoArbGetGroupTrigger',
           'GXAO_INVALID_PORT_DIRECTION',
           ...
           'GXAO_1649_TRIGGERMODE_PXI1', 'GXAO_1649_TRIGGERMODE_PXI6',
           ...
           'GXAO_1649_CLOCKSOURCE_STAR', 'GT_EVENT_DISABLE_FAILED',
           'GT_ERR_DMA_MEM_UN_MAP', 'Gt_EventCallback',
           'GT_SLOT_NOT_CONFIG', 'PSHORT', 'GT_EVENT_WAIT_ERROR',
           'GT_INVALID_CALIBRATION_TIME_STAMP',
           'GT_ERR_MODE_NOT_SUPPORTED_BY_SLOT', 'GxAoCalSetMode',
           'GXAO_1642_ZERO_TO_POS10V',

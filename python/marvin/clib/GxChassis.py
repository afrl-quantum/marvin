...
GXCHASSIS_INVALID_FAN_POLE = -55 # Variable c_int '-0x00000000000000037'
...
GXCHASSIS_ERR_ALL_BRIDGES = -64 # Variable c_int '-0x00000000000000040'
...
GXCHASSIS_UNABLE_TO_DETECT_RIGHT_BRIDGE = -67 # Variable c_int '-0x00000000000000043'
...
GXCHASSIS_INVALID_TEMPERATURE = -50 # Variable c_int '-0x00000000000000032'
GXCHASSIS_PXI_TRIGGER_BUS_LINE3 = 3 # Variable c_int '3'
GXCHASSIS_PXI_TRIGGER_BUS_LINE2 = 2 # Variable c_int '2'
GXCHASSIS_INVALID_PXI_TRIGGER_BUS_LINE_DIR = -52 # Variable c_int '-0x00000000000000034'
...
GXCHASSIS_INVALID_PXI_TRIGGER_BUS_LINE = -51 # Variable c_int '-0x00000000000000033'
GXCHASSIS_ERR_CONTROLLER_COM = -61 # Variable c_int '-0x0000000000000003d'
...
GXCHASSIS_UNABLE_TO_DETECT_BRIDGES = -65 # Variable c_int '-0x00000000000000041'
GXCHASSIS_OVER_TEMPERATURE_ALARM_ENABLE = 1 # Variable c_int '1'
GXCHASSIS_UNABLE_TO_DETECT_LEFT_BRIDGE = -66 # Variable c_int '-0x00000000000000042'
...
GXCHASSIS_ERR_LEFT_BRIDGE = -62 # Variable c_int '-0x0000000000000003e'
...
GXCHASSIS_INVALID_SEGMENT = -54 # Variable c_int '-0x00000000000000036'
GT_UNABLE_REGISTER_DEVICE = -5 # Variable c_int '-0x00000000000000005'
GXCHASSIS_ERR_CONTROLLER_TIMEOUT = -60 # Variable c_int '-0x0000000000000003c'
...
GXCHASSIS_ERR_RIGHT_BRIDGE = -63 # Variable c_int '-0x0000000000000003f'
GXCHASSIS_INVALID_CHASSIS_TYPE = -56 # Variable c_int '-0x00000000000000038'
...
GXCHASSIS_INVALID_PXI_TRIGGER_BUS_LINE_MODE = -53 # Variable c_int '-0x00000000000000035'
...
__all__ = ['GxChassisResetPxiTriggerLines', 'PDWORD',
           ...
           'GxChassisGetSlotTemperature', 'BOOL', 'GT_NOT_CALIBRATED',
           ...
           'GXCHASSIS_OVER_TEMPERATURE_ALARM_ON',

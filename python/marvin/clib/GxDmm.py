...
GXDMM_ERROR_READ_ONLY_COMMAND = -113 # Variable c_int '-0x00000000000000071'
GXDMM_RANGE_100Ohm = 100 # Variable c_int '100'
GXDMM_ERROR_INVALID_TRIGGER_TIMER_RATE = -126 # Variable c_int '-0x0000000000000007e'
...
GXDMM_ERROR_INVALID_FUNCTION = -122 # Variable c_int '-0x0000000000000007a'
...
GXDMM_ERROR_READ_ERROR = -109 # Variable c_int '-0x0000000000000006d'
GT_UNABLE_CREATE_PANEL = -8 # Variable c_int '-0x00000000000000008'
GXDMM_ERROR_INVALID_DAQ_ARRAY = -92 # Variable c_int '-0x0000000000000005c'
GXDMM_ERROR_CAL_LICENSE = -137 # Variable c_int '-0x00000000000000089'
...
GXDMM_ERROR_MBOARD_NOT_PRESENT = -112 # Variable c_int '-0x00000000000000070'
GXDMM_CAL_HiRes_R_Ref = 27 # Variable c_int '27'
GXDMM_CAL_Daq2AAC = 45 # Variable c_int '45'
GXDMM_ERROR_COMM = -121 # Variable c_int '-0x00000000000000079'
GXDMM_ERROR_INVALID_CAL_GROUP = -134 # Variable c_int '-0x00000000000000086'
GXDMM_ERROR_INVALID_APERTURE = -131 # Variable c_int '-0x00000000000000083'
GXDMM_CAL_HiRes1k_Ohms2W = 10 # Variable c_int '10'
GXDMM_ERROR_FLASH_FAIL = -110 # Variable c_int '-0x0000000000000006e'
...
GXDMM_RANGE_10mArms = 0.01 # Variable c_double '1.00000000000000002081668171172168513294309377670288085938e-2'
GXDMM_ERROR_INVALID_AUTO_ZERO_MODE = -143 # Variable c_int '-0x0000000000000008f'
GXDMM_CAL_Daq2ADC = 36 # Variable c_int '36'
GXDMM_ERROR_ABORTED_VALUE = -90 # Variable c_int '-0x0000000000000005a'
...
GXDMM_RANGE_1mA = 0.001 # Variable c_double '1.00000000000000002081668171172168513294309377670288085938e-3'
GXDMM_CAL_HiRes10k_Ohms4W = 18 # Variable c_int '18'
GXDMM_CAL_Daq100mVDC = 28 # Variable c_int '28'
GXDMM_RANGE_50mArms = 0.05 # Variable c_double '5.000000000000000277555756156289135105907917022705078125e-2'
GXDMM_ERROR_DATA_NT_READ_WARN = -96 # Variable c_int '-0x00000000000000060'
GXDMM_ERROR_BUSY = -91 # Variable c_int '-0x0000000000000005b'
GXDMM_RANGE_2A = 2.0 # Variable c_double '2.0e+0'
GXDMM_ERROR_MIN_MAX_NOT_SET = -95 # Variable c_int '-0x0000000000000005f'
GXDMM_RANGE_50mVrms = 0.05 # Variable c_double '5.000000000000000277555756156289135105907917022705078125e-2'
GXDMM_ERROR_CAL_SET_LENGTH_TOO_LONG = -118 # Variable c_int '-0x00000000000000076'
GXDMM_ERROR_GENERAL_ERROR = -101 # Variable c_int '-0x00000000000000065'
GXDMM_AUTO_ZERO_OFF = 1 # Variable c_int '1'
GXDMM_ERROR_FLASH_BAD_SIGNATURE = -115 # Variable c_int '-0x00000000000000073'
GXDMM_ERROR_INVALID_DIGITIZER_CLOCK_DIVISOR = -139 # Variable c_int '-0x0000000000000008b'
...
GXDMM_ERROR_INVALID_CAL_SET = -135 # Variable c_int '-0x00000000000000087'
...
GXDMM_ERROR_CAL_SET_BAD_CHECKSUM = -119 # Variable c_int '-0x00000000000000077'
GXDMM_RANGE_10KOhm = 10000 # Variable c_int '10000'
GXDMM_ERROR_WRAP_AROUND = -111 # Variable c_int '-0x0000000000000006f'
GXDMM_TRIGGER_CONTINUOUS = 0 # Variable c_int '0'
GXDMM_FUNCTION_TEMPERATURE = 11 # Variable c_int '11'
GXDMM_ERROR_INVALID_RESOLUTION = -124 # Variable c_int '-0x0000000000000007c'
...
GXDMM_ERROR_INVALID_CAL_SET_HEADER_CHECKSUM = -116 # Variable c_int '-0x00000000000000074'
GXDMM_ERROR_NOT_SUPPORTED = -106 # Variable c_int '-0x0000000000000006a'
GXDMM_RANGE_10V = 10.0 # Variable c_double '1.0e+1'
GXDMM_ERROR_MEM_ADDR = -201 # Variable c_int '-0x000000000000000c9'
GXDMM_FUNCTION_IAC_AC_CPL = 3 # Variable c_int '3'
GXDMM_ERROR_DEVICE_BUSY = -108 # Variable c_int '-0x0000000000000006c'
GXDMM_CAL_HiRes100k_Ohms2W = 12 # Variable c_int '12'
GXDMM_ERROR_ARRAY_EMPTY = -94 # Variable c_int '-0x0000000000000005e'
...
GXDMM_ERROR_ARRAY_OUT_BNDS = -93 # Variable c_int '-0x0000000000000005d'
GXDMM_ERROR_BAD_PARAMETER = -102 # Variable c_int '-0x00000000000000066'
GT_NOT_IN_CALIBRATION_MODE = -11 # Variable c_int '-0x0000000000000000b'
GXDMM_ERROR_MEM_ECHB = -203 # Variable c_int '-0x000000000000000cb'
...
GXDMM_ERROR_INVALID_DAQ_BUFFER_POINTER = -127 # Variable c_int '-0x0000000000000007f'
GXDMM_CAL_HiRes10M_Ohms4W = 21 # Variable c_int '21'
GXDMM_ERROR_NOT_FOUND = -104 # Variable c_int '-0x00000000000000068'
...
GXDMM_RANGE_10uA = 1e-05 # Variable c_double '1.00000000000000008180305391403130954586231382563710212708e-5'
GXDMM_CAL_HiRes100mVSHiDC = 23 # Variable c_int '23'
GXDMM_ERROR_CAL_SET_DOES_NOT_EXIST = -117 # Variable c_int '-0x00000000000000075'
GXDMM_CAL_HiRes100M_Ohms2W = 15 # Variable c_int '15'
GXDMM_ERROR_INVALID_RANGE = -123 # Variable c_int '-0x0000000000000007b'
GXDMM_ERROR_NO_CALIBRATION = -142 # Variable c_int '-0x0000000000000008e'
GT_SLOT_NOT_CONFIG = -4 # Variable c_int '-0x00000000000000004'
GXDMM_ERROR_MEM_DATA = -200 # Variable c_int '-0x000000000000000c8'
...
GXDMM_ERROR_TIMER_ALTER = -107 # Variable c_int '-0x0000000000000006b'
GXDMM_ERROR_GENERAL_WARNING = -97 # Variable c_int '-0x00000000000000061'
GXDMM_ERROR_INVALID_CAL = -133 # Variable c_int '-0x00000000000000085'
GT_VISA_LOAD_DLL_ERROR = -30 # Variable c_int '-0x0000000000000001e'
GXDMM_ERROR_CONTROLER_TIMEOUT = -141 # Variable c_int '-0x0000000000000008d'
GXDMM_ERROR_SOFTWARE_TIMEOUT = -120 # Variable c_int '-0x00000000000000078'
GXDMM_ERROR_INVALID_HIRES_BUFFER_POINTER = -129 # Variable c_int '-0x00000000000000081'
...
GXDMM_ERROR_INVALID_AC_LINE_FREQUENCY = -138 # Variable c_int '-0x0000000000000008a'
GXDMM_ERROR_SPI_BUSY = -103 # Variable c_int '-0x00000000000000067'
...
GXDMM_ERROR_INVALID_TRIGGER_READING = -125 # Variable c_int '-0x0000000000000007d'
GXDMM_FUNCTION_VAC_DC_CPL = 4 # Variable c_int '4'
GXDMM_ERROR_MEM_BHWA = -202 # Variable c_int '-0x000000000000000ca'
GXDMM_CAL_HiRes100_Ohms4W = 16 # Variable c_int '16'
GXDMM_ERROR_INVALID_DAQ_BUFFER_COUNT = -128 # Variable c_int '-0x00000000000000080'
GXDMM_FUNCTION_IDC = 1 # Variable c_int '1'
GXDMM_ERROR_INVALID_DAQ_MATH_TYPE = -132 # Variable c_int '-0x00000000000000084'
...
GXDMM_ERROR_INVALID_HIRES_BUFFER_COUNT = -130 # Variable c_int '-0x00000000000000082'
GXDMM_RANGE_1V = 1.0 # Variable c_double '1.0e+0'
GXDMM_AC_MATH_PP = 2 # Variable c_int '2'
GXDMM_RANGE_20mA = 0.02 # Variable c_double '2.00000000000000004163336342344337026588618755340576171875e-2'
...
GXDMM_RANGE_100mV = 0.1 # Variable c_double '1.000000000000000055511151231257827021181583404541015625e-1'
GXDMM_ERROR_END_OF_BUFFER = -114 # Variable c_int '-0x00000000000000072'
GXDMM_RANGE_100MOhm = 100000000 # Variable c_int '100000000'
GXDMM_ERROR_INVALID_BUFFER_TYPE = -140 # Variable c_int '-0x0000000000000008c'
GXDMM_RANGE_100V = 100.0 # Variable c_double '1.0e+2'
GXDMM_RANGE_100uA = 0.0001 # Variable c_double '1.00000000000000004792173602385929598312941379845142364502e-4'
GXDMM_ERROR_RUN_GTBN = -105 # Variable c_int '-0x00000000000000069'
GT_INVALID_MODE = -25 # Variable c_int '-0x00000000000000019'
GXDMM_RANGE_100mA = 0.1 # Variable c_double '1.000000000000000055511151231257827021181583404541015625e-1'
GXDMM_AUTO_ZERO_NOW = 2 # Variable c_int '2'
GXDMM_ERROR_INVALID_AC_MIN_FREQ = -136 # Variable c_int '-0x00000000000000088'
...
__all__ = ['GXDMM_RANGE_1Arms', 'GxDmmRead', 'GXDMM_PANEL_MODELESS',
           ...
           'GXDMM_AC_MATH_RMS', 'CHAR', 'GXDMM_CAL_HiRes1VDC',
           'GXDMM_CAL_HiRes100_Ohms2W', 'GXDMM_FUNCTION_CONTINUITY',
           'DOUBLE', 'GxDmmRestoreFactoryCalibration',
           'GxDmmReadArray', 'GXDMM_CAL_Daq100mVDC', 'PDDWORD',
           ...
           'GxDmmSetTriggerMode', 'GXDMM_CAL_Daq100VDC',
           ...
           'GxDmmSetCalibrationSet', 'GXDMM_ERROR_NO_CALIBRATION',
           ...
           'GXDMM_CAL_Daq100mVAC', 'GXDMM_RANGE_100Ohm',
           'GT_SYNC_CREATE', 'GXDMM_ERROR_INVALID_FUNCTION',
           ...
           'GT_NOT_CALIBRATED', 'GXDMM_FUNCTION_VAC_AC_CPL',
           ...
           'GXDMM_CAL_HiRes100_Ohms4W', 'GT_CANT_OPEN_HW',
           ...
           'GxDmmSetACMinFrequency', 'GxDmmTrig',
           'GxDmmGetACClockDivider', 'GXDMM_CAL_DaqTempTypeR',
           'GT_SLOT_NOT_CONFIG', 'DWORD', 'GXDMM_CAL_DaqTempTypeB',
           'UINT', 'GXDMM_RANGE_1A', 'GXDMM_LINE_FREQUENCY_400HZ',
           'GXDMM_ERROR_MEM_ECHB', 'GxDmmGetBoardSummary',
           'GxDmmGetReadStatus', 'GXDMM_CAL_Daq1ADC',
           'GXDMM_ERROR_INVALID_RANGE', 'GXDMM_RANGE_100mV',
           'GXDMM_ERROR_END_OF_BUFFER', 'GXDMM_RANGE_100MOhm',
           'GT_UNABLE_ALLOC_MEMORY', 'GXDMM_RANGE_100V',
           'GXDMM_RANGE_100uA', 'GXDMM_ERROR_RUN_GTBN',
           'GxDmmGetAutoRange', 'GT_INVALID_MODE',
           'GXDMM_RANGE_100mA', 'GXDMM_AUTO_ZERO_NOW',
           'GXDMM_RANGE_20mA', 'GXDMM_CAL_HiRes1VSHiDC',
           'GT_INVALID_HANDLE', 'GXDMM_CAL_Daq10VAC',
           'GxDmmSetACMath', 'GT_LICENSE']

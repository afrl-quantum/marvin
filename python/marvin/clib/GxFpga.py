...
# VOID = void # alias
GXFPGA_DMA_READ_TIMEOUT = -66 # Variable c_int '-0x00000000000000042'
GT_FIRMWARE_UPGRADE_MODE_SYNC = 0 # Variable c_int '0'
GXFPGA_BYPASS_BANK_B = 2 # Variable c_int '2'
GXFPGA_EXPANSION_BOARD_NOT_FOUND = -59 # Variable c_int '-0x0000000000000003b'
...
GXFPGA_EEPROM_INVALID_TIME_STAMP = -70 # Variable c_int '-0x00000000000000046'
...
GXFPGA_INVALID_DMA_DATA_SIZE = -64 # Variable c_int '-0x00000000000000040'
...
GXFPGA_EEPROM_WRITE_TIMEOUT = -72 # Variable c_int '-0x00000000000000048'
GXFPGA_DMA_WRITE_TIMEOUT = -67 # Variable c_int '-0x00000000000000043'
...
GXFPGA_FLEX_PROGRAM_FAILURE = -60 # Variable c_int '-0x0000000000000003c'
...
GXFPGA_ERROR_VOLATILE_PROGRAMMING = -53 # Variable c_int '-0x00000000000000035'
...
GXFPGA_EXTERNAL_PROGRAMMER_DETECTED = -55 # Variable c_int '-0x00000000000000037'
GXFPGA_3571_COLOR_CYAN = 1045500 # Variable c_int '1045500'
GXFPGA_EEPROM_READ_TIMEOUT = -71 # Variable c_int '-0x00000000000000047'
...
GXFPGA_FLEX_RELOAD_ERROR = -57 # Variable c_int '-0x00000000000000039'
...
GXFPGA_SIZE_NOT_DWORD = -58 # Variable c_int '-0x0000000000000003a'
GT_SLOT_NOT_CONFIG = -4 # Variable c_int '-0x00000000000000004'
GT_WRONG_BOARD = -3 # Variable c_int '-0x00000000000000003'
GT_EVENT_TMO_INFINITE = 4294967295L # Variable c_uint '4294967295u'
GXFPGA_LOAD_TARGET_VOLATILE = 0 # Variable c_int '0'
GXFPGA_DMA_READ = 0 # Variable c_int '0'
GXFPGA_INVALID_FILENAME = -51 # Variable c_int '-0x00000000000000033'
GXFPGA_ERROR_EEPROM_PROGRAMMING = -54 # Variable c_int '-0x00000000000000036'
...
GXFPGA_INVALID_DMA_OFFSET = -65 # Variable c_int '-0x00000000000000041'
GXFPGA_ERROR_OFFSET = -62 # Variable c_int '-0x0000000000000003e'
GXFPGA_3571_COLOR_BLACK = 0 # Variable c_int '0'
GXFPGA_INVALID_DATA_WIDTH = -63 # Variable c_int '-0x0000000000000003f'
GXFPGA_EXPANSION_BOARD_ID_PIO = 1 # Variable c_int '1'
GXFPGA_ERROR_DATA_WIDTH_AND_NUM_BYTES = -61 # Variable c_int '-0x0000000000000003d'
...
GXFPGA_OFFSET_OUT_OF_RANGE = -50 # Variable c_int '-0x00000000000000032'
...
GXFPGA_BUSY_LOAD_IN_PROGRESS = -56 # Variable c_int '-0x00000000000000038'
...
GXFPGA_ERROR_FILE_OPEN = -52 # Variable c_int '-0x00000000000000034'
CHAR = c_char
BYTE = c_ubyte
SHORT = c_short
WORD = c_ushort
...
__all__ = ['GXFPGA_DMA_WRITE', 'GT_FIRMWARE_UPGRADE_MODE_SYNC',
           'GXFPGA_BYPASS_BANK_B', 'PDWORD', 'GXFPGA_LOAD_MODE_ASYNC',
           'GT_NO_ERROR', 'GXFPGA_BYPASS_BANK_C',
           ...
           'GxFpgaDiscardEvents', 'GXFPGA_3571_VIDEO_MODE_STANDBY',
           ...
           'GXFPGA_BYPASS_ALL', 'GXFPGA_3571_VIDEO_MODE_NTSC',
           ...
           'GT_WRONG_BOARD', 'GT_EVENT_TMO_INFINITE',
           ...
           'GT_CANT_OPEN_HW', 'GT_BOARD_NOT_EXIST',
           ...
           'GXFPGA_BOARD_TYPE_GX3500', 'GxFpgaPioReset',

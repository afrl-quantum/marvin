...
GXPDO_UNABLE_TO_SET_DAC = -70 # Variable c_int '-0x00000000000000046'
...
GX3348_RAIL_NONE = -1 # Variable c_int '-0x00000000000000001'
...
GXPDO_INVALID_GROUP = -56 # Variable c_int '-0x00000000000000038'
GX1838_SOURCE_EXTERNAL = 2 # Variable c_int '2'
GX1838_DAC_MAX_VOLTAGE = 32.0 # Variable c_double '3.2e+1'
GXPDO_INVALID_OFFSET_VAL = -58 # Variable c_int '-0x0000000000000003a'
...
GXPDO_INVALID_RAIL_SOURCE = -55 # Variable c_int '-0x00000000000000037'
...
GXPDO_INVALID_DAC_VOLTAGE = -53 # Variable c_int '-0x00000000000000035'
GT_INVALID_PARAMETER = -21 # Variable c_int '-0x00000000000000015'
GXPDO_CAL_BY_USER_ERR_SEQUENCE = -80 # Variable c_int '-0x00000000000000050'
GX1838_SOURCE_INTERNAL = 1 # Variable c_int '1'
GXPDO_CAL_BY_USER_INVALID_CALIBRATION_DATA = -81 # Variable c_int '-0x00000000000000051'
GT_VISA_GETATTRIBUTE_ERROR = -33 # Variable c_int '-0x00000000000000021'
GXPDO_INVALID_RAIL = -54 # Variable c_int '-0x00000000000000036'
...
GXPDO_INVALID_CHANNEL = -50 # Variable c_int '-0x00000000000000032'
...
GXPDO_ADC_MEASURE_TIMEOUT = -61 # Variable c_int '-0x0000000000000003d'
GT_UNABLE_ALLOC_DEVICE_RESOURCE = -6 # Variable c_int '-0x00000000000000006'
GX1838_CAL_DATA_USER_VOLATILE = 4 # Variable c_int '4'
GXPDO_INVALID_CHANNEL_RAIL = -51 # Variable c_int '-0x00000000000000033'
...
GXPDO_CAL_BY_USER_ERROR_CHANGE_CAL_SOURCE = -83 # Variable c_int '-0x00000000000000053'
...
GXPDO_CAL_BY_USER_INVALID_LOAD_VALUE = -82 # Variable c_int '-0x00000000000000052'
...
GXPDO_INVALID_CALIBRATION_DATA_SOURCE = -59 # Variable c_int '-0x0000000000000003b'
GX3348_GROUP_B = 1 # Variable c_int '1'
GX3348_GROUP_C = 2 # Variable c_int '2'
GXPDO_INVALID_GAIN_VAL = -57 # Variable c_int '-0x00000000000000039'
GX1838_CAL_DATA_USER_NONVOLATILE = 2 # Variable c_int '2'
GX1838_RAIL_NONE = 0 # Variable c_int '0'
GX3348_GROUP_A = 0 # Variable c_int '0'
GXPDO_INVALID_DAC = -52 # Variable c_int '-0x00000000000000034'
...
GXPDO_EEPROM_BUSY_TIMEOUT = -60 # Variable c_int '-0x0000000000000003c'

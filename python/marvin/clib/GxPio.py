...
GXPIO_INVALID_STROBE_POLARITY = -55 # Variable c_int '-0x000000037'
...
GXPIO_INVALID_CHANNEL_PORT_DIRECTION = -61 # Variable c_int '-0x00000003d'
GX5732_INTERNAL_CLOCK_T0_USER_LINE4 = 6 # Variable c_int '6'
GXPIO_COUNTER_PORT_NOT_INPUT = -80 # Variable c_int '-0x000000050'
...
GXPIO_INVALID_BYTE = -42 # Variable c_int '-0x00000002a'
...
GXPIO_INVALID_DIRECTION = -58 # Variable c_int '-0x00000003a'
...
GXPIO_INVALID_BIT = -43 # Variable c_int '-0x00000002b'
...
GXPIO_INVALID_COUNTER_OR_ALL_TERMINAL_COUNT_AND_CLOCKS = -46 # Variable c_int '-0x00000002e'
GXPIO_INVALID_CLOCK_SOURCE = -48 # Variable c_int '-0x000000030'
...
GXPIO_INVALID_CHANNEL_MODE = -60 # Variable c_int '-0x00000003c'
...
GXPIO_INVALID_WORD = -41 # Variable c_int '-0x000000029'
...
GXPIO_BUFFER_WRITE_FAIL = -83 # Variable c_int '-0x000000053'
...
GXPIO_INVALID_DIVIDER = -52 # Variable c_int '-0x000000034'
...
GXPIO_INVALID_GATE_SOURCE = -51 # Variable c_int '-0x000000033'
...
GXPIO_INVALID_PORT = -40 # Variable c_int '-0x000000028'
GXPIO_INVALID_CLOCK_INTERNAL_SOURCE = -50 # Variable c_int '-0x000000032'
...
GXPIO_INVALID_PXI_TRIGGER_LINE = -64 # Variable c_int '-0x000000040'
...
GXPIO_INVALID_CLOCK = -49 # Variable c_int '-0x000000031'
...
GXPIO_UNABLE_TO_EMPTY_BUFFER = -81 # Variable c_int '-0x000000051'
...
GXPIO_INVALID_STROBE_SOURCE = -54 # Variable c_int '-0x000000036'
...
GXPIO_BUFFER_TEST_FAIL = -82 # Variable c_int '-0x000000052'
...
GXPIO_INVALID_INTERNAL_STROBE_SOURCE = -53 # Variable c_int '-0x000000035'
GX5731_PORT_DIRECTION_IN = 0 # Variable c_int '0'
GX5733_MODULE_BUFFER_EMPTY = 0 # Variable c_int '0'
GXPIO_BUFFER_READ_FAIL = -84 # Variable c_int '-0x000000054'
GXPIO_INVALID_BUFFER_SIZE = -56 # Variable c_int '-0x000000038'
...
GXPIO_INVALID_CHANNEL_STATE = -63 # Variable c_int '-0x00000003f'
...
GXPIO_INVALID_CHANNEL = -59 # Variable c_int '-0x00000003b'
...
GXPIO_INVALID_IN_LOAD_CONTROL = -45 # Variable c_int '-0x00000002d'
...
GXPIO_INVALID_CHANNEL_CONVERSION_MODE = -62 # Variable c_int '-0x00000003e'
...
GXPIO_INVALID_COUNTER = -44 # Variable c_int '-0x00000002c'
CHAR = c_char
BYTE = c_ubyte
SHORT = c_short
WORD = c_ushort
...
__all__ = ['GX5641_PXI_TRIGGER_LINE7', 'GX5641_PXI_TRIGGER_LINE6',
           ...
           'GX5642_PXI_TRIGGER_LINE1', 'GX5731_EXT_TRIGGER_LINE1',
           'Gx5732SetPort',
           'GX5731_MODULE_INTERNAL_STROBE_T0_CLOCK_IN4',
           'GX5731_MODULE_INTERNAL_STROBE_T0_CLOCK_IN5',
           'GXPIO_INVALID_BYTE', 'GX5731_EXT_TRIGGER_LINE0',
           ...
           'Gx5733ModuleSetStrobeSource', 'GX5642_PXI_TRIGGER_LINE5',
           ...
           'GX5733_PXI_TRIGGER_LINE6', 'GX5733_PXI_TRIGGER_LINE1',
           ...
           'GX5731_EXT_TRIGGER_LINE2', 'GX5642_PXI_TRIGGER_LINE2',
           'GX5642_PXI_TRIGGER_LINE3', 'GX5731_EXT_TRIGGER_LINE7',
           'GX5731_EXT_TRIGGER_LINE6', 'GX5642_PXI_TRIGGER_LINE6',
           ...
           'Gx5733ModuleSetOutputMode', 'Gx5731ModuleRun',
           ...
           'Gx5733ModuleSetDirection', 'GX5732_MAX_CLOCK_DIVIDER',
           ...
           'GT_UNABLE_ALLOC_DEVICE_RESOURCE', 'GXPIO_INVALID_PORT',
           ...
           'GX5732_NEGATIVE_EDGE', 'GX5733_PXI_TRIGGER_LINE0',
           ...
           'GX5733_MODULE_OPERATION_BUFFERED',
           ...
           'GX5733_MODULE_OUTPUT_ENABLE', 'GX5731_MODULE_BUFFER_FULL',

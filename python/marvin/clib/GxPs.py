...
GXPS_INVALID_DAC_VOLTAGE = -81 # Variable c_int '-0x00000000000000051'
GXPS_INVALID_ERROR = -99 # Variable c_int '-0x00000000000000063'
GXPS_TYPE_PMC28 = 7 # Variable c_int '7'
GT_VISA_MEMMAP_ERROR = -35 # Variable c_int '-0x00000000000000023'
GXPS_CAL_BY_USER_INVALID_STEP = -74 # Variable c_int '-0x0000000000000004a'
GXPS_AC_POWER_OFF = 2 # Variable c_int '2'
GXPS_ERR_TIMEOUT_ADC_READ = -61 # Variable c_int '-0x0000000000000003d'
...
GXPS_USERCAL_INVALID_VALUE = -73 # Variable c_int '-0x00000000000000049'
GXPS_ERR_TIMEOUT_SET_DAC_VOLTAGE = -62 # Variable c_int '-0x0000000000000003e'
...
GXPS_INVALID_VOLTAGE_SETTING_MODE = -85 # Variable c_int '-0x00000000000000055'
GXPS_CHANNEL_FAIL = -58 # Variable c_int '-0x0000000000000003a'
GXPS_INVALID_CHANNEL = -80 # Variable c_int '-0x00000000000000050'
GXPS_SET_VOLTAGE_TIMEOUT = -60 # Variable c_int '-0x0000000000000003c'
GXPS_EEPROM_GAIN_ERROR = -54 # Variable c_int '-0x00000000000000036'
GXPS_TIMEOUT = -83 # Variable c_int '-0x00000000000000053'
GXPS_TYPE_PMP30 = 1 # Variable c_int '1'
GXPS_TYPE_PMC3 = 3 # Variable c_int '3'
GXPS_PS_NOT_FOUND = -51 # Variable c_int '-0x00000000000000033'
GXPS_CHANNEL_NOT_INSTALLED = -84 # Variable c_int '-0x00000000000000054'
...
GXPS_EEPROM_OFFSET_ERROR = -53 # Variable c_int '-0x00000000000000035'
GT_NO_ERROR = 0 # Variable c_int '0'
GXPS_OUPUT_ON = 0 # Variable c_int '0'
GXPS_CHANNEL_NOT_SET_ON = -59 # Variable c_int '-0x0000000000000003b'
GXPS_INVALID_DAC_AMPERAGE = -82 # Variable c_int '-0x00000000000000052'
...
GXPS_SET_STANDBY_FAIL = -57 # Variable c_int '-0x00000000000000039'
...
GXPS_USERCAL_SEQUENCE = -71 # Variable c_int '-0x00000000000000047'
...
GXPS_SET_ON_FAIL = -56 # Variable c_int '-0x00000000000000038'
GT_INVALID_ERROR = -20 # Variable c_int '-0x00000000000000014'
GXPS_DAC_SOURCE_ERROR = -52 # Variable c_int '-0x00000000000000034'
...
GXPS_USERCAL_INVALID_FIXED_MODULE = -72 # Variable c_int '-0x00000000000000048'
GXPS_ERR_TIMEOUT_SET_DAC_CURRENT = -63 # Variable c_int '-0x0000000000000003f'
GXPS_EEPROM_NOT_CALIBRATED = -55 # Variable c_int '-0x00000000000000037'
...
GXPS_CAL_NOT_STARTED = -75 # Variable c_int '-0x0000000000000004b'
GXPS_AC_ON = 1 # Variable c_int '1'
GXPS_USERCAL_INVALID_LOAD_VALUE = -70 # Variable c_int '-0x00000000000000046'
...
GXPS_MODE_ERROR = -50 # Variable c_int '-0x00000000000000032'
...
__all__ = ['GxPsUserCalReadMeasuredVal', 'GxPsGetType',
           ...
           'GXPS_INVALID_CHANNEL', 'GxPsGetAcPowerState', 'LONG',
           ...
           'GT_NOT_IN_CALIBRATION_MODE', 'GXPS_MODE_ERROR',
           'GxPsUpgradeFirmware', 'GT_UNABLE_ALLOC_DEVICE_RESOURCE',
           ...
           'GxPsUserCalSetupForMeasurement', 'GXPS_CHANNEL_FAIL',

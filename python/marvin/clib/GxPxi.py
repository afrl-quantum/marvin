...
GXPXI_INVALID_ERROR = -99 # Variable c_int '-0x000000063'
...
GXPXI_INVALID_BOARD_PCB_VER = -45 # Variable c_int '-0x00000002d'
GXPXI_TIMEOUT_CURRENT_READ = -71 # Variable c_int '-0x000000047'
...
GXPXI_INVALID_VOLTAGE_RANGE = -41 # Variable c_int '-0x000000029'
...
GXPXI_TIMEOUT_VOLTAGE_READ = -70 # Variable c_int '-0x000000046'
GXPXI_EXTERNAL_RESET = -72 # Variable c_int '-0x000000048'
...
GXPXI_INVALID_CHANNEL = -40 # Variable c_int '-0x000000028'
...
GXPXI_ERR_VOLTAGE_OUT_OF_RANGE = -42 # Variable c_int '-0x00000002a'
GX7404_CHANNEL_PLUS3_3 = 1 # Variable c_int '1'
GT_UNABLE_ALLOC_MEMORY = -7 # Variable c_int '-0x000000007'
GXPXI_CHANNEL_NOT_CONNECTED = -44 # Variable c_int '-0x00000002c'
GXPXI_CHANNEL_BUSY_TIMEOUT = -43 # Variable c_int '-0x00000002b'
...
__all__ = ['GT_BOARD_INVALID_EEPROM', 'GXPXI_INVALID_ERROR',
           'GX7404_CHANNEL_INTERNAL', 'SHORT', 'GT_INVALID_MODE',
           ...
           'GX7404_ONBOARD_CHANNEL_PLUS3_3', 'GXPXI_STATE_CLOSE',
           'Gx7404GetChannelCurrent',
           ...
           'GT_BOARD_NOT_EXIST', 'PBOOL', 'PSTR',
           'Gx7404ConnectChannels', 'PLONG', 'GT_SLOT_NOT_CONFIG',
           'PDDWORD', 'GT_WRONG_BOARD', 'GXPXI_INVALID_CHANNEL',
           'UINT', 'GX7404_CHANNEL_NEGATIVE12',
           'GT_UNABLE_CREATE_PANEL', 'GX7404_CHANNEL_PLUS5', 'WORD',
           'GXPXI_PANEL_MODAL', 'Gx7404ConnectChannel',
           'GXPXI_ERR_VOLTAGE_OUT_OF_RANGE', 'GxPxiGetDriverSummary',
           'PSHORT', 'Gx7404Initialize', 'PVOID',
           'GX7404_CHANNEL_PLUS3_3', 'INT', 'GT_UNABLE_ALLOC_MEMORY',
           'PBYTE', 'PDOUBLE', 'GXPXI_CHANNEL_NOT_CONNECTED',

...
GXSW_INVALID_COLUMN = -85 # Variable c_int '-0x000000055'
...
GXSW_ERROR_CLOSED_RELAYS_OVER_LIMIT = -67 # Variable c_int '-0x000000043'
...
GXSW_INVALID_RELAY_CYCLES_ARRAY_SIZE = -64 # Variable c_int '-0x000000040'
...
GXSW_INVALID_RELAYS_CYCLES_LIMIT = -63 # Variable c_int '-0x00000003f'
...
GXSW_INVALID_BUS = -82 # Variable c_int '-0x000000052'
...
GXSW_INVALID_CHANNEL = -81 # Variable c_int '-0x000000051'
GX6338_CHANNEL_FIRST = 1 # Variable c_int '1'
GX6138_CHANNEL_LAST = 38 # Variable c_int '38'
GXSW_EEPROM_CHECKSUM_INVALID = -97 # Variable c_int '-0x000000061'
GX6256_MUX_MODE_MULTI_CONNECTION = 1 # Variable c_int '1'
GXSW_INVALID_GROUP = -83 # Variable c_int '-0x000000053'
...
GXSW_INVALID_SIGNAL_TYPE = -92 # Variable c_int '-0x00000005c'
GT_ERROR_FILE_NOT_EXIST = -16 # Variable c_int '-0x000000010'
GX6115_CHANNEL_LAST_HIGH_CURRENT = 15 # Variable c_int '15'
GXSW_INVALID_NUMBER_OF_RELAYS = -62 # Variable c_int '-0x00000003e'
...
GXSW_BIT_SWITCH_OTHER = -54 # Variable c_int '-0x000000036'
...
GXSW_BIT_ADAPTOR_NOT_CONNECTED = -50 # Variable c_int '-0x000000032'
...
GXSW_ERROR_OVER_LIMIT_RELAY_REPLACEMENT = -65 # Variable c_int '-0x000000041'
...
GTSW_ERROR_CLOSED_LOOP = -60 # Variable c_int '-0x00000003c'
...
GX6256_RESET_ALL = -1 # Variable c_int '-0x000000001'
...
GXSW_INVALID_RELAY_NUMBER = -61 # Variable c_int '-0x00000003d'
...
GXSW_INVALID_ROW = -84 # Variable c_int '-0x000000054'
GT_INVALID_MODE = -25 # Variable c_int '-0x000000019'
GXSW_INVALID_BLOCK = -95 # Variable c_int '-0x00000005f'
...
GXSW_EEPROM_BUSY_TIMEOUT = -66 # Variable c_int '-0x000000042'
...
GXSW_INVALID_DAISY_CHAIN_MODE = -87 # Variable c_int '-0x000000057'
...
GXSW_SIMULATION_INI_FILE_READ_ERROR = -94 # Variable c_int '-0x00000005e'
...
GXSW_INVALID_INPUT = -93 # Variable c_int '-0x00000005d'
GX6021_GROUP_RELAY1 = 0 # Variable c_int '0'
GT_SYNC_CREATE = -37 # Variable c_int '-0x000000025'
GX6192_RESET_ALL = -1 # Variable c_int '-0x000000001'
GXSW_BIT_CLOSE_COLUMN = -53 # Variable c_int '-0x000000035'
GXSW_INVALID_RELAY = -86 # Variable c_int '-0x000000056'
GX6256_GROUP_K = 10 # Variable c_int '10'
GX6021_DAISY_CHAIN_VIA_LAST_GROUP = 2 # Variable c_int '2'
GXSW_BIT_COMPARATOR = -51 # Variable c_int '-0x000000033'
...
GXSW_INVALID_GROUP_MODE = -89 # Variable c_int '-0x000000059'
...
GXSW_ERROR_SET_RELAYS_TIMEOUT = -68 # Variable c_int '-0x000000044'
...
GXSW_INVALID_PATH = -91 # Variable c_int '-0x00000005b'
...
GXSW_INVALID_ERROR = -99 # Variable c_int '-0x000000063'
GT_PARAMETER_OUT_OF_RANGE = -26 # Variable c_int '-0x00000001a'
GT_NOT_GEOTEST_BOARD = -14 # Variable c_int '-0x00000000e'
GX6384_ROW_5 = 5 # Variable c_int '5'
GX6616_GROUP_A = 0 # Variable c_int '0'
GXSW_INVALID_RELAY_TYPE = -88 # Variable c_int '-0x000000058'
...
GXSW_INVALID_SECTION = -90 # Variable c_int '-0x00000005a'
...
GXSW_INVALID_CONFIGURATION = -80 # Variable c_int '-0x000000050'
...
GXSW_ERROR_BIT_STILL_RUNNING = -96 # Variable c_int '-0x000000060'
...
__all__ = ['Gx6325Initialize', 'Gx6138Reset', 'BYTE',
           ...
           'Gx6616GetBoardSummary', 'PSTR', 'GXSW_INVALID_CHANNEL',
           ...
           'Gx6196Reset', 'GT_NOT_GEOTEST_BOARD', 'Gx6377MatrixOpen',
           ...
           'Gx6384GetGroupRow64Columns', 'GX6256_BIT_MODE_RTM',
           ...
           'GX6021_CONNECT_BREAK_BEFORE_MAKE', 'CHAR',
           'GX6138_CHANNEL_LAST', 'Gx6264InitializeVisa',
           'Gx6021Close', 'WORD', 'GXSW_REPORT_FORMAT_TXT',
           'GX6315_GROUP_A', 'GX6315_GROUP_C', 'GX6315_GROUP_B',
           'GX6325_GROUP_A', 'GX6325_GROUP_B', 'GX6325_GROUP_C',
           'Gx6325GetChannel', 'GX6377_MATRIX_CONFIG_ONE_GROUP_2X32',
           ...
           'GXSW_ERROR_SET_RELAYS_TIMEOUT', 'GX6192_GROUP_F',
           ...
           'GX6616_GROUP_B', 'GT_CANT_OPEN_HW',
           ...
           'GX6192_GROUP_D', 'GX6192_GROUP_E', 'GT_ERR_CHECKSUM',
